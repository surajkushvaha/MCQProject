<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true"
    CodeFile="SubjectList.aspx.cs" Inherits="AdminPanel_Subjects_SubjectList" %>
        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <asp:HyperLink class="btn btn-sm btn-light-success btn-active-light-primary" runat="server"
                    ID="hlAdd" NavigateUrl="~/AdminPanel/Subjects/AddEditSubject.aspx">Add</asp:HyperLink>
            </div>
        </div>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="hlEdit"
                                    Text="Edit" CssClass="btn btn-sm  btn-light-info btn-active-light" NavigateUrl='<%# "~/AdminPanel/Subjects/AddEditSubject.aspx?SubjectID=" + Eval("ExamSubjectID").ToString().Trim() %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Delete">
                            <ItemTemplate>
                                <asp:Button runat="server" ID="btnDelete" Text="Delete" CssClass="btn btn-sm btn-light-danger btn-active-danger"
                                    CommandName="deleteRecord" CommandArgument='<%# Eval("ExamSubjectID").ToString() %>'
