            ...
            <div class="card bg-primary h-md-100">
                <div class="card-body d-flex flex-column pt-13 pb-14">
                    ...
                    <div class="text-center">
                        <asp:HyperLink runat="server" class="btn btn-sm btn-white btn-color-gray-800 me-2"
                            NavigateUrl="~/AdminPanel/Questions/AddEditQuestion.aspx">Add Question</asp:HyperLink>
                        <asp:HyperLink runat="server" class="btn btn-sm bg-white btn-color-white bg-opacity-25"
                            NavigateUrl="~/AdminPanel/Questions/QuestionList.aspx">
        ...
        <div class="col-xl-6 mb-xl-10">
            <div class="card bg-info h-md-100">
                <div class="card-body d-flex flex-column pt-13 pb-14">
                    ...
                    <div class="text-center">
                        <asp:HyperLink runat="server" class="btn btn-sm btn-white btn-color-gray-800 me-2"
                            NavigateUrl="~/AdminPanel/Topics/AddEditTopic.aspx">Add Topic</asp:HyperLink>
                        <asp:HyperLink runat="server" class="btn btn-sm bg-white btn-color-white bg-opacity-20"
                            NavigateUrl="~/AdminPanel/Topics/TopicList.aspx">View Topics</asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6 mb-xl-10">
            <div class="card bg-info h-md-100">
                <div class="card-body d-flex flex-column pt-13 pb-14">
                    ...
                    <div class="text-center">
                        <asp:HyperLink runat="server" class="btn btn-sm btn-white btn-color-gray-800 me-2"
                            NavigateUrl="~/AdminPanel/Subjects/AddEditSubject.aspx">Add Subjects</asp:HyperLink>
                        <asp:HyperLink runat="server" class="btn btn-sm bg-white btn-color-white bg-opacity-20"
                            NavigateUrl="~/AdminPanel/Subjects/SubjectList.aspx">View Subjects</asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6 mb-xl-10">
            <div class="card bg-primary h-md-100">
                <div class="card-body d-flex flex-column pt-13 pb-14">
                    ...
                    <div class="text-center">
                        <asp:HyperLink runat="server" class="btn btn-sm btn-white btn-color-gray-800 me-2"
                            NavigateUrl="~/AdminPanel/Exams/AddEditExam.aspx">Add Exams</asp:HyperLink>
                        <asp:HyperLink runat="server" class="btn btn-sm bg-white btn-color-white bg-opacity-25"
                            NavigateUrl="~/AdminPanel/Exams/ExamList.aspx">View Exams</asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
